...
import os
import json
from src.tts_post_request import TextToSpeechPostRequest


# create an instance of class using the main configs
@pytest.fixture
def get_post_req_class_obj(get_main_cfgs):
    # initialize an object with general configs and run the request
    post_req_class_obj = TextToSpeechPostRequest(get_main_cfgs)
    return post_req_class_obj


# check with default options using valid api key
def test_positive_default(get_test_cases, get_post_req_class_obj):
...
def test_positive_language_en_in(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_speech_voice_mike(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_speech_rate_10(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_mpeg_codec(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_audio_format_48khz_8bit_mono(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_fr_logan_10_mpeg_stereo(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_positive_b64_true(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_speech_voice_olga_en(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_nonexisting_voice(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_nonexisting_codec(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_speech_rate_50(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_speech_rate_minus_100(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
# check the behaviour on big text, during the post request - error is returned
def test_postspec_long_txt(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
    current_test_case = get_test_cases["test_postspec_long_txt"]
    input_fields = current_test_case["input_fields"]
    output_expectations = current_test_case["output_expectations"]

    # run the request
    response = get_post_req_class_obj.send_request_data(api_key=input_fields["api_key"], src_text=input_fields["src_text"]*10000, content_language=input_fields["content_language"], speech_voice=input_fields["speech_voice"], speech_rate=input_fields["speech_rate"], audio_codec=input_fields["audio_codec"], audio_format= input_fields["audio_format"], ssml= input_fields["ssml"], out_str_format= input_fields["out_str_format"])
...
def test_specific_check_en_us_mpeg_content(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_specific_check_russian_wav_content(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_missing_api_key(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_invalid_api_key(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_inactive_account(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_subcription_expired(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_missing_text(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_not_supported_language(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_missing_language(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
...
def test_negative_ssml_subscription(get_test_cases, get_post_req_class_obj):
    # get the command arguments of current test
